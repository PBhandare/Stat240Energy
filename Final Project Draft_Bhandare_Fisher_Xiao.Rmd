...
ggplot(sectormost2011, aes(x = Sector,y = MmtCO2e,fill = Sector))+
    geom_col()
ggplot(sectormost2015, aes(x = Sector,y = MmtCO2e,fill = Sector))+
    geom_col()
ggplot(sectormost2020, aes(x = Sector,y = MmtCO2e,fill = Sector))+
    geom_col()
...
##### Variance By Year
```{r}
sector2011 = ggplot(max_sector_2011, aes(Year,MmtCO2e, color = Sector))+
    geom_point()+
    ggtitle("Total Emmisions Per Year: AEO 2020 Projections By Sector")+
    ylab("Emissions(MmtCO2e)")+
    xlab("Year")
sector2015 = ggplot(sectormost2015, aes(YearNum,MmtCO2e, color = Sector))+
geom_point()+
    ggtitle("Total Emmisions Per Year: AEO 2020 Projections By Sector")+
    ylab("Emissions(MmtCO2e)")+
    xlab("Year")
sector2020 =  ggplot(sectormostyear, aes(NumYear,MmtCO2e, color = Sector))+
    geom_point()+
    ggtitle("Total Emmisions Per Year: AEO 2020 Projections By Sector")+
    ylab("Emissions(MmtCO2e)")+
    xlab("Year")

plot_grid(sector2011,sector2020, nrow = 1)
```
