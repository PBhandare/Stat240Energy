...
lm2011A = ggplot(lm2011, aes(Year,MmtCO2e))+
  geom_smooth(method = "lm", se = FALSE)+
  ggtitle("Linear Model For the Decade 2020-2030",
          subtitle = "2011 Projections")+
  scale_x_continuous(breaks = c(2020,2025,2030))

lm2015A = ggplot(lm2015, aes(Year,MmtCO2e))+
  geom_smooth(method = "lm", se = FALSE)+
  ggtitle("Linear Model For the Decade 2020-2030",
          subtitle = "2015 Projections")+
  scale_x_continuous(breaks = c(2020,2025,2030))

grid.arrange(lm2011A,lm2015A, ncol= 2)

ggplot(lm2020, aes(Year,MmtCO2e))+
  geom_smooth(method = "lm", se = FALSE)+
   ggtitle("Linear Model For the Decade 2020-2030",
          subtitle = "2020 Projections")+
  scale_x_continuous(breaks = c(2020,2025,2030))
