...
# Introduction
  ...
  There are 3 focuses for our study, the first is how the most used energy source and sector changes throughout the decade and the reason behind the changes. As the technology and concept of environmental fredinliness, we think the main energy source used in emission and consumption will become cleaner and more efficient. The second is how the total consumption and the total emission changed throughout the decades. We think that the efficiency of the energy use will be better and the total consumption and emission will decrease or become more environmental friendly. The third is that how does the prediction based on the previous dataset compare to the later dataset as we are using the datas from a 10-year period. We think that some of the prediction will have major changes because of the changes in main energy source and other factors. 
