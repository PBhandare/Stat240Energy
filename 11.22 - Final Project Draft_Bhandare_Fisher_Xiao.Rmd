...
```{r, include = FALSE}
E2020 =read_csv("../data/emissions2020.csv")
C2020 = read_csv("../data/consumption2020.csv")
...
```{r}
E2011 =read_csv("../data/emissions2011.csv")
C2011 = read_csv("../data/consumption2011.csv")
