...
C2010 <- read_csv("Data/Consumption/C2010.csv") %>%
  mutate(originDataSet = "2010")
C2012 <- read_csv("Data/Consumption/C2012.csv" )%>%
  mutate(originDataSet = "2012")
C2013 <- read_csv("Data/Consumption/C2013.csv") %>%
  mutate(originDataSet = "2013")
C2014 <- read_csv("Data/Consumption/C2014.csv") %>%
  mutate(originDataSet = "2014")
C2015 <- read_csv("Data/Consumption/C2015.csv") %>%
  mutate(originDataSet = "2015")
C2016 <- read_csv("Data/Consumption/C2016.csv") %>%
  mutate(originDataSet = "2016")
C2017 <- read_csv("Data/Consumption/C2017.csv") %>%
  mutate(originDataSet = "2017")
C2018 <- read_csv("Data/Consumption/C2018.csv") %>%
  mutate(originDataSet = "2018")
C2019 <- read_csv("Data/Consumption/C2019.csv") %>%
  mutate(originDataSet = "2019")
C2020 <- read_csv("Data/Consumption/C2020.csv") %>%
  mutate(originDataSet = "2020")
```

```{r echo = FALSE}
actual_consumptions <- C2012 %>%
...
```{r message = FALSE, warning = FALSE, echo = FALSE}
E2010 <- read_csv("Data/Emission/E2010.csv") %>%
  mutate(originDataSet = "2010")

E2010 <- E2010[-c(3, 30, 31), ]

E2012 <- read_csv("Data/Emission/E2012.csv")%>%
  mutate(originDataSet = "2012")

E2012 <- E2012[-c(3), ]

E2013 <- read_csv("Data/Emission/E2013.csv") %>%
  mutate(originDataSet = "2013")

E2013 <- E2013[-c(3), ]

E2014 <- read_csv("Data/Emission/E2014.csv") %>%
  mutate(originDataSet = "2014")
E2015 <- read_csv("Data/Emission/E2015.csv") %>%
  mutate(originDataSet = "2015")

E2015 <- E2015[-c(29), ]

E2016 <- read_csv("Data/Emission/E2016.csv") %>%
  mutate(originDataSet = "2016")
E2017 <- read_csv("Data/Emission/E2017.csv") %>%
  mutate(originDataSet = "2017")
E2018 <- read_csv("Data/Emission/E2018.csv") %>%
  mutate(originDataSet = "2018")
E2019 <- read_csv("Data/Emission/E2019.csv") %>%
  mutate(originDataSet = "2019")
E2020 <- read_csv("Data/Emission/E2020.csv") %>%
  mutate(originDataSet = "2020")
```

```{r echo = FALSE}
actual_emissions <- E2010 %>%
...
In this plot, we demonstrate the changes in emissions of energy from various sectors for each year in the past from 2007 up till 2019. We clearly notice a reduction in emissions from each sector's consumption for each subsequent years based on the regression lines.
